  ...
  <link rel="stylesheet" href="{{asset('public/userpanel/assets/vendors/datatables.net-bs4/dataTables.bootstrap4.css')}}">
  <link rel="stylesheet" href="{{asset('public/userpanel/assets/vendors/ti-icons/css/themify-icons.css')}}">
  <link rel="stylesheet" type="text/css" href="{{asset('public/userpanel/assets/js/select.dataTables.min.css')}}">
